...
def ProcessFetch(char, stdin):
    ...
    sys.stdout.flush()
    aggregated += char
    if aggregated.endswith("Password for 'https://github.com/AaronKovacs/Baja-Car-Onboard.git':"):
        print(mainLogger, "Entering password...", True)
        stdin.put("yourpassword\n")

if __name__ == "__main__":
    checkTimeSec = 30
    gitDir = "/home/pi/Baja-Car-Onboard/"
    #if extProc is None:
    #    extProc = sp.Popen(['python', '/home/pi/2048-Pi-Display/main.py'])
    while True:
